...
const Navbar = () => {
  ...
  return (
    <header
      id="header"
      className={`fixed top-0 left-0 right-0 h-24 z-50 flex items-center justify-center transition-opacity duration-300 mix-blend-difference pointer-events-none ${isNavVisible ? "opacity-100" : "opacity-0"}`}
    >
      {/* Left digit */}
      <div
        aria-hidden="true"
